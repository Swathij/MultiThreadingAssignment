...
public class Broker {
	...
	/*
	 * For instance which has a termination condition of fixedMessages,
	 * m_continueEnqueing is set by producer to indicate the termination of
	 * message Enqueue.
	 */
	...
	/*
	 * Consumer uses m_continueEnqueing to determine if producer is still
